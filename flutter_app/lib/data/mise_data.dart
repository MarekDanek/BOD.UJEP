...
final List<Mise> vsechnyMise = [
  ...
  Mise(
    ...
    obrazekCesta: 'assets/_obecna_Kofina_uvod.png', 
    ...
    trasa: [
      BodMise(
        ...
        obrazekCesta: 'assets/1_0_zmrzlina.png', 
        ...
        lon: 14.0175233,
        obrazkyMise: [
            ObrazekMise(obrazek: 'assets/1_1.png'),
            ObrazekMise(obrazek: 'assets/1_2.png'),
            ObrazekMise(obrazek: 'assets/1_3.png'),
            ObrazekMise(obrazek: 'assets/1_4.png'),
            ObrazekMise(obrazek: 'assets/1_5.png'),
        ]
      ),
      BodMise(
        id: 2,
      ...
      BodMise(
        ...
        lon: 14.0223244,
        obrazkyMise: [
          ObrazekMise(obrazek: 'assets/4_0.png'),
          ObrazekMise(obrazek: 'assets/4_1.png'),
        ]
      ...
      BodMise(
        ...
        lon: 14.0160044,
        obrazkyMise: [
          ObrazekMise(obrazek: 'assets/7_0.png'),
          ObrazekMise(obrazek: 'assets/7_1.png'),
        ]
      ),
    ],
  ),
